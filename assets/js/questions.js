...
function updatePage(questions) {
	...
	const g3r1author_el = document.querySelector(".g3-question-author.r-1");
	...
	const g3r2author_el = document.querySelector(".g3-question-author.r-2");
	...
	const g3r3author_el = document.querySelector(".g3-question-author.r-3");
